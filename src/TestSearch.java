...
public class TestSearch {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] param = { "./resources_test/xmap1.txt", "5" }; // Name starts with x to avoid displaying map
		String correct;
		...
		param[0] = "./resources_test/xmap2.txt";
		param[1] = "8";
		...
		param[0] = "./resources_test/xmap3.txt";
		param[1] = "22";
		...
		String[] param2 = { "./resources_test/xmap4.txt" };
		...
		param[0] = "./resources_test/xmap5.txt";
		param[1] = "250";
		...
		param[0] = "./resources_test/xmap6.txt";
		param[1] = "7";
		...
		param[0] = "./resources_test/xmap7.txt";
		param[1] = "10";
