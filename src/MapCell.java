...
public class MapCell extends CellComponent {
	...
	private CellType type; // Stores the current type of this cell. This value changes as the cells in the
	// map are marked
	...
	public static enum CellType {
		BLOCK, INITIAL, TARGET, CROSS_PATH, INITIAL_PROCESSED, TARGET_PROCESSED, INITIAL_POPPED, IN_STACK, OUT_STACK,
	 ...
	 *
	 * @param neighbor The new cell neighbor
	 * @param i        The index specifying which side this neighbor is on (0-3
	 *                 inclusive)
	 * @throws InvalidNeighbourIndexException When an index is specified that is not
	 *                                        0-3.
	 */
	 ...
	 *
	 * The index for the neighbor indicates in which side of the cell the neighbor
	 * is: 0-3.
	 *
	 * @param i The index of the neighbor
	 * @return The cell that is on the i-th side of the current cell, or null if no
	 *         neighbor
	 * @throws InvalidNeighbourIndexException When an index is specified that is not
	 *                                        0-3.
	 */
	...
	/**
	 * Set the colour/image of the cell in the visual JFrame based on its type and
	 * stack status.
	 *
	 *
	 * @param type The cell's type from the enum made at the top of this class.
	 *
	 */
	...
	/**
	 * This method checks if the current cell has been marked as in stack or out of
	 * stack.
	 *
	 * @return true if this cell has been marked as in stack or out of stack, false
	 *         otherwise.
	 */
	...
	/**
	 * This method marks the starting cell as the initial cell and updates the
	 * cell's colour
	 */
	...
	public String toString() {
		...
		return this.identifier + " " + this.originalType;
	}
